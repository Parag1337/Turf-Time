...
document.addEventListener('DOMContentLoaded', function() {
  var testimonialCarousel = document.getElementById('testimonialIndicator');
  if (testimonialCarousel) {
    testimonialCarousel.addEventListener('slide.bs.carousel', function () {
      // Remove old animation classes
      var activeItems = testimonialCarousel.querySelectorAll('.carousel-item.active .testimonial-card');
    ...
    testimonialCarousel.addEventListener('slid.bs.carousel', function () {
      // Apply animation to new active item
      var activeItem = testimonialCarousel.querySelector('.carousel-item.active .testimonial-card');
      if (activeItem) {
        activeItem.style.animation = 'testimonial-fade-in 0.7s forwards';
      }
    });
  }
});
